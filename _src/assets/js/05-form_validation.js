...
function validatePhone() {
  ...
  if (/^[0-9]{9}/.test(inputPhone.value) || inputPhone.value === '') {
...
function validateAll() {
  if (validateJob() === true && validateFullName() === true && validateEmail() === true && validateLinkedin() === true && validateGithub() === true && validateImage() === true && validatePhone()===true){
